...
setwd("C:/Users/messuti/Documents/Reports/4 Überpruft Ergebnise/Excel Tables Final Results/1 CDC")


# 1. Admited to HAI ------------------------------------------------------------

# 1) Read file
Results_Adm_to_HAI <- read_excel("4.1 Results CDC _ Adm to HAI.xlsx", sheet = 1)
...
# 1) Leer el Excel
Results_Adm_to_Disch <- read_excel("4.2 Results CDC_ Adm to Disch.xlsx", sheet = 1)
...
# 1) Leer el Excel
Results_HAI_to_Disch <- read_excel("4.3 Results CDC_ HAI to Disch.xlsx", sheet = 1)
...
############### PLOTS ONLY CDC IPW WITH AND WITHOUT BOOTSTRAPPING ###########

######################### ADM -> HAI ##############################
# 1) Leer el Excel (Asegúrate de que el archivo esté en la carpeta de trabajo)
Results_Adm_to_HAI <- read_excel("4.4 Results CDC _ Adm to HAI - 5 y 6.xlsx", sheet = 1)
...
######################### ADM -> DISCH ##############################
# 1) Leer el Excel (Asegúrate de que el archivo esté en la carpeta de trabajo)
Results_Adm_to_HAI <- read_excel("4.5 Results CDC_ Adm to Disch - 5 y 6.xlsx", sheet = 1)
...
######################### HAI -> DISCH ##############################
# 1) Leer el Excel (Asegúrate de que el archivo esté en la carpeta de trabajo)
Results_Adm_to_HAI <- read_excel("4.6 Results CDC_ HAI to Disch - 5 y 6.xlsx", sheet = 1)
